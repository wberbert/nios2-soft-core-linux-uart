...
module NIOS2_Design_mm_interconnect_0 (
	...
	wire    [7:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> MMU_s1_agent:cp_channel
	...
	wire  [103:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> timer_1_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                       // timer_1_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> MMU_s2_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> MMU_s2_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                       // MMU_s2_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> MMU_s2_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> MMU_s2_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> MMU_s2_agent:cp_endofpacket
	...
	wire  [103:0] timer_1_s1_agent_rp_data;                                                    // timer_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire          mmu_s2_agent_rp_valid;                                                       // MMU_s2_agent:rp_valid -> router_009:sink_valid
	wire  [103:0] mmu_s2_agent_rp_data;                                                        // MMU_s2_agent:rp_data -> router_009:sink_data
	wire          mmu_s2_agent_rp_ready;                                                       // router_009:sink_ready -> MMU_s2_agent:rp_ready
	wire          mmu_s2_agent_rp_startofpacket;                                               // MMU_s2_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          mmu_s2_agent_rp_endofpacket;                                                 // MMU_s2_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          mmu_s2_agent_rdata_fifo_src_valid;                                           // MMU_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] mmu_s2_agent_rdata_fifo_src_data;                                            // MMU_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          mmu_s2_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_007:in_0_ready -> MMU_s2_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> MMU_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> MMU_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                           // MMU_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> MMU_s2_agent:rdata_fifo_sink_error
	...
	NIOS2_Design_mm_interconnect_0_router_002 router_008 (
	...
	NIOS2_Design_mm_interconnect_0_router_009 router_009 (
	...
	NIOS2_Design_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (CLK_50_clk_clk),                          //       clk.clk
		.reset               (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS2_Design_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (CLK_50_clk_clk),                          //       clk.clk
		.reset              (NIOS2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
